...
public class BottomSheetStyle extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.item_filterstyle, container, false);
        ...
        for(int i = 0; i < indexList.size(); i++){
            ...
            curList = indexList.get(i).getStyleTag();
        ...
        ListView listView = view.findViewById(R.id.list_styles);
        listView.setAdapter(new ListAdapter(requireContext(), list, new ListAdapter.OnClickListener() {
            @Override
            public void onClick(String input) {
                Bundle bundle = new Bundle();
                bundle.putString("selectedItemStyle", input);
                getParentFragmentManager().setFragmentResult("requestStyle", bundle);
                dismiss();
            }
        }));
